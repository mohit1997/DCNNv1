...
def main():
    train_data = create_dataloader(128, 'aplawd_train/speech', 'aplawd_train/peaks', 160, 3, select=160)
    test_data = create_dataloader(128, 'aplawd_test/speech', 'aplawd_test/peaks', 160, 20, select=160)
    model = MyNet()
    save_model = Saver('checkpoints/aplawd_female')
    use_cuda = True
    epochs = 16
